...
/**
 * An abstraction of HTTP client that communicates with the locally running native execution process. It exposes server level endpoints to simple method calls.
 */
@ThreadSafe
public class PrestoSparkHttpServerClient
{
    private static final Logger log = Logger.get(PrestoSparkHttpServerClient.class);
    private static final String NATIVE_EXECUTION_ID = "NativeExecution";
            ...
            ScheduledExecutorService scheduledExecutor)
    {
        ...
        this.errorTracker = nativeExecutionRequestErrorTracker(NATIVE_EXECUTION_ID, serverUri, maxErrorDuration, scheduledExecutor, "getting native process status");
    }
